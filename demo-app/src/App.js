...
class App extends Component {
  render() {
    return <div>
              ...
              <div className="fluid-container text-center">
                <form onSubmit={e => {
                  ...
                  <div className="list-group-item">
                    ...
                    <input onChange={e => (validation.inputValue = e.target.value)} id="someSwitchOptionSuccess" name="someSwitchOption001" type="submit" />
        ...
        <a id="next" className="btn btn-info btn-block" href="">
          NEXT
        </a>
        <div id="nextDiv1" />
      </div>;
